...
cd data-pusher
mvn clean install
docker build -t data-pusher-service1:v1 -f ./resources/service-dockerfile .
...
docker build -t data-pusher-service2:v1 -f ./resources/service-dockerfile .
...
docker build -t data-pusher-service3:v1 -f ./resources/service-dockerfile .
...
docker build -t data-pusher-service4:v1 -f ./resources/service-dockerfile .
