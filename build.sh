...
mvn clean install
cd ..
cp data-pusher/target/springredis-0.0.1-SNAPSHOT.jar data-pusher/resources/input-data/
docker build -t data-pusher-service1:v1 -f ./data-pusher/resources/service-dockerfile .
...
docker build -t data-pusher-service2:v1 -f ./data-pusher/resources/service-dockerfile .
...
docker build -t data-pusher-service3:v1 -f ./data-pusher/resources/service-dockerfile .
...
docker build -t data-pusher-service4:v1 -f ./data-pusher/resources/service-dockerfile .
docker build -t redisdb:v1 ./data-pusher/resources/redis-dockerfile .
cd data-pusher
docker-compose up 
